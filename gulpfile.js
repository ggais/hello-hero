...
gulp.task('watch-dev', ['clean-build-app-dev', 'validate-devserver-scripts'], function() {
    ...
    plugins.nodemon({ script: 'server/server.js', ext: 'js', watch: ['server/'], env: {NODE_ENV : 'development'} })
...
gulp.task('watch-prod', ['clean-build-app-prod', 'validate-devserver-scripts'], function() {
    ...
    // start nodemon to auto-reload the dev server
    plugins.nodemon({ script: 'server/server.js', ext: 'js', watch: ['server/'], env: {NODE_ENV : 'production'} })
        .on('change', ['validate-devserver-scripts'])
        .on('restart', function () {
            console.log('[nodemon] restarted dev server');
        });
...
gulp.task('default', ['clean-build-app-prod'], function () {
    return pipes.test()
});
